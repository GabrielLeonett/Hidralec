...
class userController extends mainModel
{
    ...
    public function registrarUsuario()
    {
        ...
        # Función que verifica si el cliente ya está registrado
        if ($this->VerificarExistencia('usuario',$prueba_de_usuario) == false && $this->VerificarExistencia('usuario',$prueba_de_correo) == false) {
    ...
    public function loginUsuario(){
        ...
        if ($correo || $usuario) {
            ...
            $existeUsuario = $this->VerificarExistencia('usuario', $verificar);
